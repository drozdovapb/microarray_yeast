...
Here we apply hypergeometric distribution to answer the question whether these intersections could be due to chance.
...
## hypergeometric distribution III
...
Genes upregulated in both comparisons (p = `r pm_up_dms_up`) and genes downregulated in both comparisons (p = `r pm_down_dms_down`) 
Genes downregulated by [ISP+] and upregulated by deletion: p = `r pm_down_dms_up`.
Genes upregulated by [ISP+] and downregulated when SFP1 is deleted): p = `r pm_up_dms_down`. 
